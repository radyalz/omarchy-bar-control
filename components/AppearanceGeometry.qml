...
ColumnLayout {
  ...
  ValueSlider {
    label: "Edge margin"; from: 0; to: 40; stepSize: 1; suffix: " px"
  ...
  ValueSlider {
    label: "Padding"; from: 0; to: 32; stepSize: 1; suffix: " px"
  ...
  ValueSlider {
    label: "Gap"; from: 0; to: 32; stepSize: 1; suffix: " px"
  ...
  ValueSlider {
    label: "Inset"; from: 0; to: 12; stepSize: 1; suffix: " px"
  ...
  ValueSlider {
    label: "Corner radius"; from: 0; to: 40; stepSize: 1; suffix: " px"
